...
@section('admin/title', 'Post Category')
                    ...
                    <tr>
                      ...
                      <td> 
                        <div class="buttons d-flex">
                            <a href="/administrator/news/post-categories/edit/{{base64_encode($allCatData->id)}} " class="btn btn-icon  btn-primary"><i class="far fa-edit"></i></a>
                            <a href="/administrator/news/post-categories/delete/{{base64_encode($allCatData->id)}}" onclick="return confirm('are you sure?')" class="btn btn-icon btn-danger"><i class="fas fa-trash-alt"></i></a>
                        </div>
                      </td>
                    </tr>
                    @endforeach
