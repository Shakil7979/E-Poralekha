...
// service active class add js 
var service_cat = document.querySelectorAll('.service_cat'); 
for(var i = 0; i < service_cat.length; i++){
	service_cat[i].querySelectorAll('.service_item')[0].classList.add("active"); 
} 



// function contactForm(){ //send new post data   
...
//         var url = "/administrator/home/send-email";
